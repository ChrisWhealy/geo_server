...
%% cc2               : alternate country codes, comma separated, ISO-3166 2-letter
...
%%                     (ca 900mx900m) area in meters, integer. srtm processed by
%%                     cgiar/ciat.
%% timezone          : the iana timezone id (see file timeZone.txt) varchar(40)
%% modification date : date of last modification in yyyy-MM-dd format

-record(geoname, {id, name, asciiname, alternatenames, latitude, longitude,
                  feature_class, feature_code, country_code, cc2,
                  admin1, admin2, admin3, admin4, population, elevation, dem,
                  timezone, modified}).

%% -----------------------------------------------------------------------------
%% Internal version of Geoname record.  Same as above minus asciiname,
%% alternatenames, cc2, elevation, dem (digital elevation model) and modified

-record(geoname_int, {id, name, latitude, longitude, feature_class, feature_code,
                      country_code, admin1, admin2, admin3, admin4,
                      population, timezone,
                      admin1_txt, admin2_txt, admin3_txt, admin4_txt}).
